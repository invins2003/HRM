...
//                     ),
//
//                     // 🔽 Buttons moved to bottom-right corner
...
//           );
//           if (result == true) {
//             controller.fetchEmployeeLeaves(
//               widget.empId,
...
//     bool isEditable =
//         leave.status == "Pending"; // Only pending leaves are editable
//
...
//
//     int selectedLeaveTypeId = leave.leaveTypeId ?? 0;
//
//     Get.dialog(
//       Dialog(
...
//                         ? (val) {
//                             if (val != null) selectedLeaveTypeId = val;
//                           }
//                         : null,
//                   );
//                 }),
...
//                             context: context,
//                             initialDate: initiatedDate ?? DateTime.now(),
...
//                           );
//                           if (picked != null) {
//                             initiatedDate = picked;
//                             initiatedDateController.text = DateFormat(
//                               "dd MMM yyyy",
//                             ).format(picked);
//                           }
//                         }
...
//                         ),
//                         onPressed: () async {
//                           // Update leave object locally
//                           leave.leaveTypeId = selectedLeaveTypeId;
//                           leave.appliedOn = initiatedDate != null
//                               ? DateFormat("yyyy-MM-dd").format(initiatedDate!)
//                               : leave.appliedOn;
//                           leave.startDate = startDate != null
//                               ? DateFormat("yyyy-MM-dd").format(startDate!)
//                               : leave.startDate;
//                           leave.endDate = endDate != null
...
class _EmployeeLeavesScreenState extends State<EmployeeLeavesScreen> {
                  ...
                  children: [
                    ...
                    if (isEditable)
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          leave.leaveTypeId = selectedLeaveTypeId;
                          leave.appliedOn = DateFormat(
                            "yyyy-MM-dd",
                          ).format(initiatedDate ?? DateTime.now());
                          leave.startDate = DateFormat(
                            "yyyy-MM-dd",
                          ).format(startDate ?? DateTime.now());
                          leave.endDate = DateFormat(
                            "yyyy-MM-dd",
  ...
  /// 🔹 Reusable Date Picker with future date disabled
