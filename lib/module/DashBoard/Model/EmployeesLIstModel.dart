...
// Helper function to decode JSON, you can place this in your main file or a utility file.
EmployeesListModel employeesListModelFromJson(String str) => EmployeesListModel.fromJson(json.decode(str));

String employeesListModelToJson(EmployeesListModel data) => json.encode(data.toJson());
